...
// ============================================================
const USER_ROLES = {
  "gudang1@perusahaan.com": { role: "gudang", nama: "Budi Santoso", lokasi: "Gudang A" },
  "gudang2@perusahaan.com": { role: "gudang", nama: "Siti Rahayu", lokasi: "Gudang B" },
  "kepala.gudang@perusahaan.com": { role: "kepala_gudang", nama: "Ahmad Fauzi", lokasi: "Semua" },
